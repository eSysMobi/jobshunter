		...
		getListView().setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (preferences.getString("apiKey", "").equals("")
					...
					if (((MainActivity) getActivity()).getFrTag().equals(
							"logRegFrag")) {
						((MainActivity) getActivity())
								.getFragmentManager()
								.beginTransaction()
								.replace(R.id.frmCont, logReqFragment,
										"logRegFrag").commit();
						((MainActivity) getActivity()).setFrTag("logRegFrag");
					...
					if (!((MainActivity) getActivity()).getFrTag().equals(
							...
							&& !(((MainActivity) getActivity())
									.getFragmentManager().findFragmentById(
											R.id.frmCont) instanceof JobsFragment)) {
